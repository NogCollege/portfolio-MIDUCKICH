...
Меня зовут Ефремов Глеб, я студент 3 курса Ногинского колледжа. Увлекаюсь веб-разработкой, созданием пользовательских интерфейсов и изучением современных технологий. Стремлюсь к постоянному профессиональному росту и развитию в IT-сфере.
...
|--------|----------|------------|
| [Интернет-магазин](index.html) | Полнофункциональный макет интернет-магазина | HTML, CSS, JS, Bootstrap |

### 📚 Учебные проекты

- [Галерея](projects/gallery/) - Интерактивная галерея изображений
- [Другие работы](https://www.youtube.com/watch?v=Cxmvq1MCR3c) - Мои другие работы 
...
- **Email**: [cococono.email@example.com](mailto:your.email@example.com)
- **VK**: [vk.com/your_profile](https://vk.com/your_profile)
- **Телеграм**: [@colik](https://t.me/yournickname)
- **GitHub**: [github.com/MIDUCKICH](https://github.com/MIDUCKICH)
